...
export const escrowContractAddress = "0xF639C54CcE5678eA50AD4eEC4e82D11EB3526431";
export const assetTokenContractAddress = "0x4abDedE9d9e833364FcD259416781Ba2826a191A";
...
// Converts a Hedera Account ID (e.g., "0.0.123") to a 0x-prefixed EVM address.
export function toEvmAddress(accountId) {
    if (!accountId) return null;
    try {
        return `0x${AccountId.fromString(accountId).toSolidityAddress()}`;
    } catch (e) {
        console.error(`Error converting account ID "${accountId}" to EVM address:`, e);
        return null;
    }
}
