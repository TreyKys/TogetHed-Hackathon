...
import { getFirestore, collection, addDoc, onSnapshot, Timestamp, doc, getDoc, query, where, getDocs, updateDoc, setDoc } from "firebase/firestore";
...
export { db, collection, addDoc, onSnapshot, Timestamp, doc, getDoc, query, where, getDocs, updateDoc, setDoc };
